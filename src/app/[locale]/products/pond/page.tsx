...
const Page: FC = () => {
  ...
  // Filter only pond products (IDs 1-4)
  const pondProducts = products.filter(product => product.id >= 1 && product.id <= 4);
  ...
  return (
    ...
    >
      ...
      <div className="w-1/2 flex-col md:flex">
